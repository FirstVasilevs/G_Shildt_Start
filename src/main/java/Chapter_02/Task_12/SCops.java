...
public class SCops {
    ...
    public static void main(String[] args) {
        ...
        // А теперь те же самые действия выполняются без использования укороченного логического
        // оператора. В результате возникнет ошибка деления на нуль.
        if (d != 0 & (n % d) == 0)
            System.out.println(d + " является делителем" + n);
    }
}
